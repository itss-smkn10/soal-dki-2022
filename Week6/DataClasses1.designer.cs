...
namespace Week6
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="week_2_ITSS")]
    ...
    partial void DeleteSalesDetail(SalesDetail instance);
		...
		public DataClasses1DataContext() : 
				base(global::Week6.Properties.Settings.Default.week_2_ITSSConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnBirthDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Administrator_SalesHeader", Storage="_SalesHeaders", ThisKey="Id", OtherKey="AdministratordId")]
    ...
    partial void OnIdChanging(string value);
    partial void OnIdChanged();
    partial void OnAdministratordIdChanging(int value);
    partial void OnAdministratordIdChanged();
    ...
    partial void OnCardNumberChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AdministratordId", DbType="Int NOT NULL")]
		public int AdministratordId
		{
			get
			{
				return this._AdministratordId;
			}
			set
			{
				if ((this._AdministratordId != value))
				{
					if (this._Administrator.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnAdministratordIdChanging(value);
					this.SendPropertyChanging();
					this._AdministratordId = value;
					this.SendPropertyChanged("AdministratordId");
					this.OnAdministratordIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Administrator_SalesHeader", Storage="_Administrator", ThisKey="AdministratordId", OtherKey="Id", IsForeignKey=true)]
		public Administrator Administrator
		{
			...
			set
			{
							...
							|| (this._Administrator.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.SalesHeaders.Add(this);
						this._AdministratordId = value.Id;
					}
					else
					{
						this._AdministratordId = default(int);
					}
